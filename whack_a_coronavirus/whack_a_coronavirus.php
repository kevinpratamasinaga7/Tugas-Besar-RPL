<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$simpan = mysqli_query($koneksi, "INSERT INTO whack_a_coronavirus (nickname, score)
        ...
        echo "<script>
                ...
                document.location='whack_a_coronavirus.php';
            </script>";
        }
        else
        {
...
<html lang="en">
    <head>
        ...
        <title>Whack a CoronaVirus!</title>
    ...
    <body>
        ...
        <!-- Judul Game, Skor & Tombol Mulai -->
        <div class="col-sm-12">
            <canvas id="canvas-complex"></canvas>
            <h1>Whack a CoronaVirus!</h1>
            <h2>Your Score</h2> 
            <h3 class="papan-skor">0</h3>
            <button type="button" class="btn btn-primary mulai" onclick="mulai()">Start!</button>
        </div>
        ...
        <!-- Efek Suara Game -->
        <audio src="audio/pukul.mp3" id="pop"></audio>
        <!-- Script Game -->
